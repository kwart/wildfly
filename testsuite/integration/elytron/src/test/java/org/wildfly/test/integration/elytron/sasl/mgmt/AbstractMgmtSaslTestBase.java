...
public abstract class AbstractMgmtSaslTestBase {
    ...
    protected static final int CONNECTION_TIMEOUT_IN_MS = 6 * 1000;
    ...
    public void testWrongCredentialsFail() throws Exception {
        ...
        Assume.assumeFalse("Skipping PLAIN mechanism, as the one from JDK is wrongly used.", "PLAIN".equals(mechanismName));
        AuthenticationConfiguration authnCfg = AuthenticationConfiguration.EMPTY.allowSaslMechanisms(mechanismName)
                ...
                //FIXME this also seems not to be working - as the PLAIN mechanism implementation is selected the one from JDK 
//                .useProviders(() -> new Provider[] { PROVIDER_ELYTRON })
                ;
    ...
    protected void assertAuthenticationFails(String message) {
