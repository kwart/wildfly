...
@ServerSetup({ SecurityTraceLoggingServerSetupTask.class, DigestMd5MgmtSaslTestCase.ServerSetup.class })
public class DigestMd5MgmtSaslTestCase extends AbstractMgmtSaslTestBase {
    ...
    public void testOtherMechsFail() throws Exception {
        assertMechFails("ANONYMOUS");
        assertMechFails("");
        assertMechFails("1DIGEST-MD5");
        assertMechFails("PLAIN");
        assertMechFails("SCRAM-SHA-1");
        assertMechFails("JBOSS-LOCAL-USER");
    }
